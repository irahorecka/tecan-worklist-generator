...
global dilution
global final_v
sample_loc = input("Please input first sample source location (e.g. A1): ")
dilution = input("What is your target concentration? (ng.uL): ")
final_v = input("What is your desired final volume? (uL): ")
rack_type_source = input("Source labware type: ")
rack_source = input("Source labware name: ")
rack_type_dest = input("Destination labware type: ")
rack_dest = input("Destination labware name: ")
dil_type_source = "VWR Block"
dil_source = "TE"
is_correct = input("Are these inputs correct? [y/n]: ")

if is_correct.lower() == "y":
    csv_direct = '/Users/irahorecka/Desktop/Harddrive_Desktop/Python/Worklist_for_TECAN/csv'
    txt_direct = '/Users/irahorecka/Desktop/Harddrive_Desktop/Python/Worklist_for_TECAN/txt'
    xlsx_direct = '/Users/irahorecka/Desktop/Harddrive_Desktop/Python/Worklist_for_TECAN/xlsx'
    ...
    for filename in os.listdir(os.getcwd()):
        ...
        #don't override existing directory
                ...
                #dest_direct = new_dir
        #else: 
            #stores files with made directories in lost_files directory
            #dest_direct = '/Users/irahorecka/Desktop/Harddrive_Desktop/Python/Worklist_for_TECAN/lost_files'
